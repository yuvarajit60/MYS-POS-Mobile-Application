...
class TripEntryGraphScreen extends StatefulWidget {
  const TripEntryGraphScreen({super.key});

  @override
  State<TripEntryGraphScreen> createState() => _TripEntryGraphScreenState();
}

class _TripEntryGraphScreenState extends State<TripEntryGraphScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Trip Entry Graph')),
      body: Padding(
              ...
              child: _loading
                  ...
                  : _error != null
                      ...
                      : _points.every((p) => p.totalAmount == 0)
                          ? const Center(child: Text('No trip entry data for this period.'))
                          : _buildChart(),
            ),
          ],
        ),
