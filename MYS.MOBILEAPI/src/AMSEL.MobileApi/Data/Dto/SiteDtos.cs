...
public record CreateSiteRequest(string SiteName, string AreaName, int AreaId, int CityId, int CustomerId);

public record UpdateSiteRequest(string SiteName, string AreaName, int AreaId, int CityId, int CustomerId);
